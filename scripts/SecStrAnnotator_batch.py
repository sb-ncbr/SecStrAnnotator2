...
parser.add_argument('--dll', type=str, default=path.join(path.dirname(__file__), 'SecStrAnnotator.dll'), help='Path to the SecStrAnnotator DLL (default: SecStrAnnotator.dll)')
