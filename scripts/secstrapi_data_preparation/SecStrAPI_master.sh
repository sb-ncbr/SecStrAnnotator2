...
SECSTRANNOTATOR_DLL="$SCRIPT_DIR/SecStrAnnotator2.dll"
...
# SECSTRANNOTATOR_OPTIONS="--soft  --label2auth  --maxmetric 25,0.5,0.5"  # Use without --verbose for SecStrAPI
SECSTRANNOTATOR_OPTIONS="--soft  --label2auth  --maxmetric 25,0.5,0.5  --verbose"  # Use with --verbose for anatomy analyses
