...
parser.add_argument('--fields', help='Comma-separated list of fields which should be kept in "secondary_structure_elements"', 
    type=str,
    default='label,chain_id,start,end,auth_chain_id,auth_start,auth_start_ins_code,auth_end,auth_end_ins_code,type,color,sheet_id,metric_value,confidence,sequence'
)
