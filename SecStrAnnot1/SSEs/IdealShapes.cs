...
namespace protein.SSEs
{
	...
	public static class IdealShapes
	{
		...
		private static void InitializeDictionary(){
			...
			foreach (char type in SSE.ALL_HELIX_TYPES) {
				idealShapeDictionary.Add (type, idealHelixH);
			}
			foreach (char type in SSE.ALL_SHEET_TYPES) {
				idealShapeDictionary.Add (type, idealSheetE);
			}
