...
namespace SecStrAnnot2
{
    public static class CifWrapperForSecStrAnnot1_New {
        ...
        /*private static Cif.Components.Atom[] AtomsFromModel(Model model) {
            throw new NotImplementedException();
            AtomTable atoms = model.Atoms;
            ResidueTable residues = model.Residues;
            ChainTable chains = model.Chains;

            Cif.Components.Atom[] atomArray = new Cif.Components.Atom[atoms.Count];
            ...
            for (int iAtom = 0; iAtom < atoms.Count; iAtom++) {
                ...
                atomArray[iAtom] = new Cif.Components.Atom(serial, name, altLoc, resName, chainIdString, resSeq, insCode, x, y, z, occupancy, tempFactor, elementString, charge, isHetatm);
            }
